Cracked MultiMC
===============
just build it normally, log in with a microsoft or minecraft account, and launch offline! tada. easy.
to see the code to make it cracked: [Commit](https://github.com/twarped/Launcher/commit/a99a758b0fe55ac7a58bac6d2f889a0aa6531d3a) also, when you launch it, it'll say "wanna play the demo?" just click yes

PS:
===
this is kinda illegal, so don't go crying to multimc about this. and you do have to build this one yourself.
<p align="center">
